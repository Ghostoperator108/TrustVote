...
export declare namespace TrustVote {
...
export interface TrustVoteInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface TrustVote extends BaseContract {
  connect(runner?: ContractRunner | null): TrustVote;
  waitForDeployment(): Promise<this>;

  interface: TrustVoteInterface;
  ...
  getCandidates: TypedContractMethod<
    [],
    [TrustVote.CandidateStructOutput[]],
    "view"
  >;
  ...
  issueVoterID: TypedContractMethod<[voter: AddressLike], [void], "nonpayable">;
  ...
  ): TypedContractMethod<[], [TrustVote.CandidateStructOutput[]], "view">;
  getFunction(
